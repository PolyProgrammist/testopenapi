...
pub mod types {
    ...
    ///JsonRpcRequestForRpcParamsAndTxEnum
    ///
    /// <details><summary>JSON schema</summary>
    ///
    /// ```json
    ///{
    ///  "title": "JsonRpcRequest_for_RpcParams_and_Tx_enum",
    ///  "type": "object",
    ///  "required": [
    ///    "id",
    ///    "jsonrpc",
    ...
    pub struct JsonRpcRequestForRpcParamsAndTxEnum {
    ...
    impl ::std::convert::From<&JsonRpcRequestForRpcParamsAndTxEnum>
        for JsonRpcRequestForRpcParamsAndTxEnum
    {
        fn from(value: &JsonRpcRequestForRpcParamsAndTxEnum) -> Self {
            value.clone()
        }
    }
    ...
    pub struct RpcParams {
        ...
        pub request_data: RpcTransactionStatusRequest,
    }

    impl ::std::convert::From<&RpcParams> for RpcParams {
