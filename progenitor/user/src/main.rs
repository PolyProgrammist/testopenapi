...
async fn print_transaction() -> Result<(), Box<dyn Error>> {
    ...
    let payloadBlock = keeper::types::JsonRpcRequestForBlock {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForBlockMethod::Block,
    ...
    let payloadChunk = keeper::types::JsonRpcRequestForChunk {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForChunkMethod::Chunk,
    ...
    let payloadGasPriceWithBlock = keeper::types::JsonRpcRequestForGasPrice {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForGasPriceMethod::GasPrice,
        params: keeper::types::RpcGasPriceRequest {
            block_id: Some(keeper::types::BlockId::Variant1(block_hash.clone()))
        }
    };

    let payloadGasPriceWithoutBlock = keeper::types::JsonRpcRequestForGasPrice {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForGasPriceMethod::GasPrice,
        params: keeper::types::RpcGasPriceRequest {
    ...
    let payloadHealth = keeper::types::JsonRpcRequestForHealth {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForHealthMethod::Health,
        params: keeper::types::RpcHealthRequest(serde_json::Map::new())
    };

    let payloadLightClientExecutionProof = keeper::types::JsonRpcRequestForLightClientProof {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForLightClientProofMethod::LightClientProof,
    ...
    let payloadNextLightClientBlock = keeper::types::JsonRpcRequestForNextLightClientBlock {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForNextLightClientBlockMethod::NextLightClientBlock,
        params: keeper::types::RpcLightClientNextBlockRequest {
            last_block_hash: block_hash.clone(),
        }
    };

    let payloadNetworkInfo = keeper::types::JsonRpcRequestForNetworkInfo {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForNetworkInfoMethod::NetworkInfo,
        params: keeper::types::RpcNetworkInfoRequest(serde_json::Map::new())
    };

    // let payloadSendTx = keeper::types::JsonRpcRequestForSendTx {
    //     id: String::from("dontcare"),
    //     jsonrpc: String::from("2.0"),
    //     method: keeper::types::JsonRpcRequestForSendTxMethod::SendTx,
    //     params: keeper::types::RpcSendTransactionRequest {
    //         signed_tx_base64: signed_tx_base64.clone(),
    //         wait_until: keeper::types::TxExecutionStatus::Executed
    //     }
    ...
    // let payloadTx = keeper::types::JsonRpcRequestForTx {
    //     id: String::from("dontcare"),
    //     jsonrpc: String::from("2.0"),
    //     method: keeper::types::JsonRpcRequestForTxMethod::Tx,
    ...
    let payloadStatus = keeper::types::JsonRpcRequestForStatus {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForStatusMethod::Status,
    ...
    let payloadClientConfig = keeper::types::JsonRpcRequestForClientConfig {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForClientConfigMethod::ClientConfig,
        params: keeper::types::RpcClientConfigRequest(serde_json::Map::new())
    };

    let payloadStateChanges = keeper::types::JsonRpcRequestForExperimentalChanges {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForExperimentalChangesMethod::ExperimentalChanges,
    ...
    let payloadChangesInBlock = keeper::types::JsonRpcRequestForExperimentalChangesInBlock {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForExperimentalChangesInBlockMethod::ExperimentalChangesInBlock,
        params: keeper::types::RpcStateChangesInBlockRequest::BlockId(keeper::types::BlockId::Variant1(block_hash.clone()))
    };

    let payloadCongestionLevel = keeper::types::JsonRpcRequestForExperimentalCongestionLevel {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForExperimentalCongestionLevelMethod::ExperimentalCongestionLevel,
    ...
    let payloadGenesisConfig = keeper::types::JsonRpcRequestForExperimentalGenesisConfig {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForExperimentalGenesisConfigMethod::ExperimentalGenesisConfig,
        params: keeper::types::GenesisConfigRequest(serde_json::Map::new())
    };

    let payloadExpLightClientExecutionProof = keeper::types::JsonRpcRequestForExperimentalLightClientProof {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForExperimentalLightClientProofMethod::ExperimentalLightClientProof,
        params: keeper::types::RpcLightClientExecutionProofRequest::Variant0 {
            light_client_head: block_hash.clone(),
            sender_id: sender_account_id.clone(),
            transaction_hash: transaction_hash.clone(),
    ...
    let payloadExpLightClientBlock = keeper::types::JsonRpcRequestForExperimentalLightClientBlockProof {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForExperimentalLightClientBlockProofMethod::ExperimentalLightClientBlockProof,
    ...
    let payloadProtocolConfig = keeper::types::JsonRpcRequestForExperimentalProtocolConfig {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForExperimentalProtocolConfigMethod::ExperimentalProtocolConfig,
        params: keeper::types::RpcProtocolConfigRequest::BlockId(keeper::types::BlockId::Variant1(block_hash.clone()))
    };

    let payloadReceipt = keeper::types::JsonRpcRequestForExperimentalReceipt {
        id: String::from("dontcare"),
        jsonrpc: String::from("2.0"),
        method: keeper::types::JsonRpcRequestForExperimentalReceiptMethod::ExperimentalReceipt,
        params: keeper::types::RpcReceiptRequest {
            receipt_id: "GVpXUxpyo715x7fcvFuzJMJ1zimU1vCJggVwMyGAM6oH".parse().unwrap(),
        }
    };

    // let payloadExpTxStatus = keeper::types::JsonRpcRequestForExperimentalTxStatus {
    //     id: String::from("dontcare"),
    //     jsonrpc: String::from("2.0"),
    //     method: keeper::types::JsonRpcRequestForExperimentalTxStatusMethod::ExperimentalTxStatus,
    //     params: keeper::types::RpcTransactionStatusRequest::Variant1 {
    //         tx_hash: transaction_hash.clone(),
    //         sender_account_id: sender_account_id.clone(),
    //         wait_until: keeper::types::TxExecutionStatus::None,
    ...
    let gas_price_without_block: keeper::types::JsonRpcResponseForRpcGasPriceResponseAndRpcError = client_remote.gas_price(&payloadGasPriceWithoutBlock).await?.into_inner();
